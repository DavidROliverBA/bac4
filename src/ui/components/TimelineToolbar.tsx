    ...
    >
      ...
      <button
        ...
        style={{
          ...
          backgroundColor: isFirst ? UI_COLORS.backgroundSecondary : UI_COLORS.backgroundPrimary,
      ...
      <button
        ...
        style={{
          ...
          borderRadius: BORDER_RADIUS.normal,
          border: `1px solid ${UI_COLORS.border}`,
          backgroundColor: isLast ? UI_COLORS.backgroundSecondary : UI_COLORS.backgroundPrimary,
