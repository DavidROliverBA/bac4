...
export class AnnotationService {
	 ...
	 */
	static validateAnnotationProperties(
	 ...
	 */
	static bulkCreateAnnotations(
		optionsList: CreateAnnotationOptions[]
	): Annotation[] {
